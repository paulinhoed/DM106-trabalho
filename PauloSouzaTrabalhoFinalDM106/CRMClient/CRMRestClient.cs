...
namespace PauloSouzaTrabalhoFinalDM106.CRMClient
{
    public class CRMRestClient
    {
        ...
        public CRMRestClient()
        {
            ...
            byte[] str1Byte = System.Text.Encoding.UTF8.GetBytes(string.Format("{0}:{1}",
           "crmwebapi", "crmwebapi"));
        ...
        public Customer GetCustomerByEmail(string email)
        {
            ...
            HttpResponseMessage response = client.GetAsync("customers/byemail?email="
           + email).Result;
